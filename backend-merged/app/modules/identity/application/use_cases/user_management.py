...
from app.modules.identity.domain.events.user_events import UserDeactivatedEvent, UserProfileUpdatedEvent
...
class DeactivateUserUseCase:
    ...
    async def execute(self, user_id: str) -> UserResponseDTO:
        ...
        await event_bus.publish(UserDeactivatedEvent(user_id=user.id))
        return _to_dto(user)
